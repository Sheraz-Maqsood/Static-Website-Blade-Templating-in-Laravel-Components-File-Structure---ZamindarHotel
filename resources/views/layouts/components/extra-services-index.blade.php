        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="reservations mb-30">
                    ...
                    <div class="text">
                        <p class="color-2">For information</p> <a href="tel:855-100-4444">(042) 37222354</a>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="pricing-card">
                        ...
                        <div class="desc">
                            ...
                            <div class="amount">Rs. 1000/- <span>/ daily</span></div>
                            <ul class="list-unstyled list">
                                <li><i class="ti-check"></i> Water & Soft drinks</li>
                                <li><i class="ti-check"></i> Beverages</li>
                                <li><i class="ti-close unavailable"></i>Alcohol</li>
                            </ul>
                        </div>
                    </div>
                    <div class="pricing-card">
                        ...
                        <div class="desc">
                            ...
                            <div class="amount">Free <span>/ daily</span></div>
                            <ul class="list-unstyled list">
                                <li><i class="ti-check"></i> Pratha</li>
                                <li><i class="ti-check"></i> Egg</li>
                                <li><i class="ti-close unavailable"></i>TEA</li>
                            </ul>
                        </div>
                    </div>
                    <div class="pricing-card">
