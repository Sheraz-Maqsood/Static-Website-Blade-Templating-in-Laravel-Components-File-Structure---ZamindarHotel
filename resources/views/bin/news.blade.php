...
<!-- zamindarhotel.pears.info/demo/html/cappa/demo6-dark/news, Sun, 13 Aug 2023 10:10:30 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <nav class="cappa-menu">
                <ul>
                    ...
                    <li class='cappa-menu-sub'><a class="active" href='#'>News <i class="ti-angle-down"></i></a>
                        <ul>
                            <li class="active"><a href='news'>News 1</a></li>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <ul class="news-pagination-wrap align-center mb-30 mt-30">
                        <li><a href="news#"><i class="ti-angle-left"></i></a></li>
                        <li><a href="news#">1</a></li>
                        <li><a href="news#" class="active">2</a></li>
                        <li><a href="news#">3</a></li>
                        <li><a href="news#"><i class="ti-angle-right"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
